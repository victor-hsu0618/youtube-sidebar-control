...
## 1. Icons
| Asset Name | Path | Requirements |
| :--- | :--- | :--- |
| Store Icon (128x128) | `icons/icon128.png` | Exactly 128x128 PNG |

## 2. Screenshots (Required)
The following screenshots have been prepared at 1280x800 or normalized for vertical display:
- **Main View**: `screenshots/screenshot1_main.png`
- **Group Play**: `screenshots/screenshot2_group_play.png`
- **Favorites**: `screenshots/screenshot3_favorites.png`
- **Library**: `screenshots/screenshot4_library.png`
- **Group Management**: `screenshots/screenshot5_groups.png`
- **Advanced Controls**: `screenshots/screenshot6_advanced.png`

## 3. Promotional Tiles (Optional but Recommended)
- **Small Promo (440x280)**: `promo_440x280.png` - Used on the main page of the Web Store.
- **Large Promo (920x680)**: `promo_920x680.png` - Used in search results and featured categories.
...
### Suggested Description (Traditional Chinese):
